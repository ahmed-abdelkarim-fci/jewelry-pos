...
export class MainLayoutComponent implements OnInit {
  ...
  menuItems = [
    ...
    { icon: 'person', labelKey: 'nav.personalPersons', route: '/personal-persons', roles: ['ROLE_SUPER_ADMIN', 'ROLE_ADMIN', 'MANAGER'] },
    { icon: 'account_balance_wallet', labelKey: 'nav.personalAccounts', route: '/personal-accounts', roles: ['ROLE_SUPER_ADMIN', 'ROLE_ADMIN', 'MANAGER'] },
    { icon: 'business', labelKey: 'nav.supplierAccounts', route: '/supplier-accounts', roles: ['ROLE_SUPER_ADMIN', 'ROLE_ADMIN', 'MANAGER'] },
    { icon: 'home', labelKey: 'nav.homeExpenses', route: '/home-expenses', roles: ['ROLE_SUPER_ADMIN', 'ROLE_ADMIN', 'MANAGER'] },
    { icon: 'local_shipping', labelKey: 'nav.suppliers', route: '/suppliers', roles: ['ROLE_SUPER_ADMIN', 'ROLE_ADMIN', 'MANAGER'] },
